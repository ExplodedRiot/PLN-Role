...
use App\Http\Requests\Driver\DepartmentRequest;
...
class DepartmentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.driver.department.list', [
            'no'        => $no,
            'items'     => $items 
        ]);
    }
    ...
    {
        return view('pages.driver.department.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.driver.department.edit', [
            'item'  => $item 
        ]);
    }
