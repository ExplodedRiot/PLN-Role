...
use App\Http\Requests\Driver\ComputerRequest;
...
class ComputerController extends Controller
{
    ...
    {
        return view('pages.driver.computer.list');
    }
    ...
    {
        return view('pages.driver.computer.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages.driver.computer.edit', [
            'item'  => $item 
        ]);
    }
