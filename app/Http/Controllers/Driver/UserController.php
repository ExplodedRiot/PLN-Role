...
use App\Http\Requests\Driver\TechAddUserRequest;
...
class UserController extends Controller
{
    ...
    public function index() {
        return view('pages.driver.user.list');
    }

    public function create() {
        $departments = Department::all();

        return view('pages.driver.user.create', [
    ...
    public function edit($id) {
        ...
        return view('pages.driver.user.edit', [
            'item'          => $item,
            'departments'   => $departments  
        ]);
    }
