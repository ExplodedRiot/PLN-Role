...
use App\Http\Requests\Driver\FollowedUpRequestRequest;
...
class FollowedUpRequestController extends Controller
{
    ...
    public function index() {
        return view('pages.driver.followed_up_request.list');
    }

    public function show($id) {
        $item = UserRequest::findOrFail($id);

        return view('pages.driver.followed_up_request.show', [
            'item'  => $item 
        ]);
    }
    ...
    public function edit($id) {
        ...
        return view('pages.driver.followed_up_request.edit', [
            'item'          => $item,
            'drivers'    => $drivers
        ]);
    }
    ...
    public function update(FollowedUpRequestRequest $request, $id) {
        ...
        return redirect()->route('driver.f-up-request');
    }
}
