...
use App\Http\Requests\CleaningService\TechAddUserRequest33;
...
class UserController extends Controller
{
    ...
    public function index() {
        return view('pages.cleaningservice.user.list');
    }

    public function create() {
        $departments = Department::all();

        return view('pages.cleaningservice.user.create', [
            'departments'   => $departments
        ]);
    }

    public function store(TechAddUserRequest3 $request) {
    ...
    public function edit($id) {
        ...
        return view('pages.cleaningservice.user.edit', [
            'item'          => $item,
            'departments'   => $departments  
        ]);
    }

    public function update(TechAddUserRequest3 $request, $id) {
